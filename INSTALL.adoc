...
To run tests you'll want to either install tappy or choose some other
consumer for Test Anything Protocol and tell test/Makefile about it.
...
The package should recommend tappy, CVS and Subversion, though not
require them.
