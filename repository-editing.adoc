...
was not yet supported in pathsets. The regex, path rename and
{branch|tag|reset} rename commands used Python-style ratrher than
Go-style match references. Macro argument formals did not yet
have a % prefix. The split command syntax was incompatibly
different.
