...
@min([.gitignore]) remove .gitignore
...
The "tip" command present in 4.24 and esrlier has been removed,
...
evber ued in the wild.

In versions 4.24 and earlier the behavior of the "unite" command
was incompatibly different it that it took master branch from the last
