...
the command language, used both in evebt selections and
...
profile [live|start|save|bench] [PORT | SUBJECT [FILENAME]]::
    ...
    bench```' jas an internal helper for the repobench script. There
...
In versions 4.23 and earlier, several commands tha now had the form
