...
does. The "elapsed", "memory", and "sizeof" subcommands of "show" used
to be separate commands. Blob/tag/reset creation used to be
...
was a "script" command separate from "do",
