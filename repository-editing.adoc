...
"readlimit" command doing what "set readlimit" now does. The "elapsed",
"memory", and "sizeof" subcommands of "show" used to be separate
commands. Tasg creation used to be "tag create", not "create tag".
...
[SELECTION] create {repo NAME|blob NAME [<INFILE]|tag NAME}
