...
Subversion mergeinfos, being file- and dirtectory-oriented rather than
...
discard those poperties to get a clean conversion.

See the embedded help listed by "repocutter help swapsvn" for some
details and caveats.

==== Using the --branchify flag

Note: this feature is deprecated and may be removed in a future release/
