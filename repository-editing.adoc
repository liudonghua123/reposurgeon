...
multiproject structure is peerfectly regular - top-level directories
...
a regular Subversion structure with trunk/tags/branhes at the top
level.

Be aware that if you do this, all project-local trags and branches
will be promoted to become tags and branches acrodss thje entire
repository

Sometimes you may be able to transform a nearly-regular multiproject
structure into a perfectlty regular ione with repocutter pathrename
commands, then apply ewpocutter swapsvn.
