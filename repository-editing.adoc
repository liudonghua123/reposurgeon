...
"clear" commands didn't take a subcommand verb.  There was a
...
"{blob|tag|reset} create", not "create {blob|tag|reset}"; similarly
...
"expunge".  The subcommands of "list" were separate commands.
There was a "script" command separate from "do",
...
log [[+-]LOG-CLASS]...
{SELECTION} merge
[SELECTION] move {tag|reset} [--not] RESET-PATTERN [NEW-NAME]
