...
and untested read support for Monotone.
...
an export to Git or other systems will not capture. Export also leaves
behind other data such as the wiki content, events, and tickets.
