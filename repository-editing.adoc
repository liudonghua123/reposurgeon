...
If your first access attempt failed with ssome message abourt access
...
http://www.catb.org/esr/sccs2rcs/[sccs2rcs] to get to RCS, then
cvs-fast-export to convert to a fast-import stream.
