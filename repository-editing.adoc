...
Ip give you the flavor of the command language, here
...
with variable datas following.

There's no way you can dicriminate by time in an authors file.
...
The blob command now takes an explict mark, rather than creating a new
