...
repositories was just "rename", not "rename repo";
"rename {path|branch|tag|reset}" was "{path|branch|tag|reset} rename".
The "delete path" command was named "expunge".  The subcommands of
"list" were separate commands.
...
[SELECTION] reset {move [--not] RESET-PATTERN [NEW-NAME]
[SELECTION] tag {move} [TAG-PATTERN] [--not] [NEW-NAME]
