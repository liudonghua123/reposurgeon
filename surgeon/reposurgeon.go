...
var _Helps = []help{
	help{"6. Finding your way around:", []string{"help", "history", "shell"}},

	help{"7. General command syntax", nil},
	help{"  1. Regular Expressions:", []string{"regexp"}},
	help{"  2. Selection syntax:", []string{"selection", "functions"}},
	help{"  3. Command syntax:", []string{"syntax"}},
	help{"  4. Redirection and shell-like features:", []string{"redirection"}},

	help{"8. Import and Export", nil},
	help{"  1. Reading and writing repositories:", []string{"read", "write"}},
	help{"  2. Repository type preference:", []string{"prefer", "sourcetype"}},
	help{"  3. Rebuilds in place:", []string{"rebuild"}},
	help{"  5. File preservation:", []string{"preserve", "unpreserve"}},
	help{"  6. Incorporating release tarballs:", []string{"incorporate"}},
	help{"  7. The repository list:", []string{"choose", "drop", "rename"}},

	help{"9. Information and reports", nil},
	help{"  1. Reports on the DAG:", []string{"list", "index", "stamp", "tip", "tags", "inspect", "graph", "lint"}},
	help{"  2. Statistics:", []string{"stats", "count", "sizes"}},
	help{"  3. Examining tree states:", []string{"manifest", "checkout", "diff"}},

	help{"10. Surgical Operations", nil},
	help{"  1. Commit deletion:", []string{"squash", "delete"}},
	help{"  2. Commit mutation:", []string{"merge", "unmerge", "reparent", "split", "add", "remove", "tagify", "reorder"}},
	help{"  3. Branches, tags, and resets:", []string{"branch", "tag", "reset", "branchlift"}},
	help{"  4. Repository splitting and merging:", []string{"divide", "expunge", "unite", "graft"}},
	help{"  5. Metadata editing:", []string{"msgout", "msgin", "setfield", "attribution", "show", "set", "delete", "prepend", "append", "gitify", "filter"}},
	help{"  6. Path reports and modifications:", []string{"path", "setperm"}},
	help{"  7. Timequakes and time offsets:", []string{"timequake", "timeoffset"}},
	help{"  8. Miscellanea:", []string{"quit", "blob", "renumber", "dedup", "transcode", "debranch", "strip"}},

	help{"11. Artifact handling", nil},
	help{"  1. Attributions:", []string{"authors"}},
	help{"  2. Ignore patterns:", []string{"ignores"}},
	help{"  3. Reference lifting:", []string{"references", "legacy"}},
	help{"  4. Changelogs:", []string{"changelogs"}},
	help{"  5. Clique coalescence:", []string{"coalesce"}},

	help{"12. Control Options:", []string{"set", "clear"}},

	help{"13. Scripting and debugging support", nil},
	help{"  1. Variables, macros, and scripts:", []string{"assign", "unassign", "names", "define", "do", "undefine", "script", "print"}},
	help{"  2. Housekeeping:", []string{"gc", "when"}},
	help{"  3. Debugging and diagnostics:", []string{"resolve", "log", "logfile", "version", "hash", "sizeof"}},
	help{"  4. Profiling:", []string{"elapsed", "timings", "readlimit", "memory", "profile", "exit", "bench"}},
}
