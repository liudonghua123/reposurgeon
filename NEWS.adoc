...
Repository head::
     ...
     Simplified syntax of split command.
     ...
     When enabling logging flags, the "+" syntax is now optional.
     "set" and "clear" are now "set flag" and "clear flag".
     The "readlimit" command has been merged into "set readlimit".
     "tag create" becomes "creare tag". 
