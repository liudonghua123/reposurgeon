...
the "repository" function in common-setup.sh. Its subcommands give you
...
When writing generators you can assume that in between "repository
init" and "repository wrap" you are in the repository's working
directory and can use native VCS commands.  This is especially
relevant with Subversion; the "repository" pseudofunctions are
...
By design, the "repository" functions do not suppress message
