...
# shellcheck disable=SC2086
${REPOCUTTER:-repocutter} -q -t "$(basename $0)" -r 5 deselect <mergeinfo.svn 2>&1 | ${REPOCUTTER:-repocutter} -q -t "$(basename $0)" see 2>&1 | diff -u --label A --label B /tmp/mergeinfo$$.see -
exit 0
